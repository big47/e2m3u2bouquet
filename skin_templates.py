...
# so the look and feel of all e2m3u2bouquet embedded screens is uniform

# screen has always been 800 x 500 so stick with that.
# button size was always 140 x 40 so stick with that.
# use 8 px margin either side of buttons and 4 px margin above and below
# button bar width = 48 + 140 + 48 + 140 + 48 + 140 + 48 + 140 + 48 = 800
...
descriptionsFontSize = fontSize - 4 # hints texts
windowWidth = 800 # button bar needs a minimum of 600
